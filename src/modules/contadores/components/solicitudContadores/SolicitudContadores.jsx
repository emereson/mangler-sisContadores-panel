...
import TablaSolicitudContadores from "./components/TablaSolicitudContadores";

const SolicitudContadores = ({ userData }) => {
  ...
  return (
    <div className="w-full  h-full p-4 flex flex-col gap-3">
      <h2 className="font-semibold text-lg">Solicitud Contadores</h2>
      ...
      <TablaSolicitudContadores pedidos={pedidos} />
    </div>
  );
};

export default SolicitudContadores;
